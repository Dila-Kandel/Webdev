    ...
    def __init__(self, root):
        ...
        def addData():
            if (len(Reference.get()) != 0):
                EmployeeDatabase.addEmployeerec(Reference.get(), Firstname.get(), Surname.get(), Address.get(),
                                                Gender.get(),
                                                Mobile.get(), NINumber.get(), stdLoan.get(), Tax.get(), Pension.get(),
                                                Deductions.get(), NetPay.get(), GrossPay.get())
                lstEmployee.delete(0, END)
                lstEmployee.insert(END, (
                Reference.get(), Firstname.get(), Surname.get(), Address.get(), Gender.get(), Mobile.get(),
                NINumber.get(), stdLoan.get(), Tax.get(), Pension.get(), Deductions.get(), NetPay.get(),
                GrossPay.get()))
        ...
        def searchData():
            lstEmployee.delete(0, END)
            for row in EmployeeDatabase.searchData(Reference.get(), Firstname.get(), Surname.get(), Address.get(),
                                                   Gender.get(),
                                                   Mobile.get(), NINumber.get(), stdLoan.get(), Tax.get(),
                                                   Pension.get(), Deductions.get(), NetPay.get(), GrossPay.get()):
                lstEmployee.insert(END, row, str(""))
        ...
        # 18:23 youtube
        # =====================Widget=============================================================
        self.lalReference = Label(LeftFrame1, font=('arial', 12, 'bold'), text="Reference", bd=7, anchor='w',
                                  bg='gainsboro')
        self.lalReference.grid(row=0, column=0)
        self.txtReference = Entry(LeftFrame1, font=('arial', 12, 'bold'), bd=5, width=60, justify='left',
                                  textvariable=Reference)
        self.txtReference.grid(row=0, column=1)

        self.lalFirstname = Label(LeftFrame1, font=('arial', 12, 'bold'), text="Firstname", bd=7, anchor='w',
                                  bg='gainsboro')
        self.lalFirstname.grid(row=1, column=0)
        self.txtFirstname = Entry(LeftFrame1, font=('arial', 12, 'bold'), bd=5, width=60, justify='left',
                                  textvariable=Firstname)
        self.txtFirstname.grid(row=1, column=1)

        self.lalSurname = Label(LeftFrame1, font=('arial', 12, 'bold'), text="Surname", bd=7, anchor='w',
                                bg='gainsboro')
        self.lalSurname.grid(row=2, column=0)
        self.txtSurname = Entry(LeftFrame1, font=('arial', 12, 'bold'), bd=5, width=60, justify='left',
        ...
        self.txtGender = Entry(LeftFrame1, font=('arial', 12, 'bold'), bd=5, width=60, justify='left',
                               textvariable=Gender)
        ...
        self.txtMobile = Entry(LeftFrame1, font=('arial', 12, 'bold'), bd=5, width=60, justify='left',
                               textvariable=Mobile)
        self.txtMobile.grid(row=4, column=1)
        # youtbe 26:30
        # ==========================================================================================
        self.lalCityWeighting = Label(LeftFrame2Left, font=('arial', 12, 'bold'), text="City Weighting", bd=7,
                                      anchor='w', bg='gainsboro')
        ...
        self.lalBasicSalary = Label(LeftFrame2Left, font=('arial', 12, 'bold'), text="Basic Salary", bd=7, anchor='w',
                                    bg='gainsboro')
        ...
        self.lalOverTime = Label(LeftFrame2Left, font=('arial', 12, 'bold'), text="Over Time", bd=7, anchor='w',
                                 bg='gainsboro')
        ...
        self.lalOtherPaymentDue = Label(LeftFrame2Left, font=('arial', 12, 'bold'), text="Other Payment", bd=7,
                                        anchor='w', bg='gainsboro')
        ...
        self.lblPension = Label(LeftFrame2Right, font=('arial', 12, 'bold'), text="Pension", bd=7, anchor='w',
                                bg='gainsboro', justify=LEFT)
        ...
        self.lblstdLoan = Label(LeftFrame2Right, font=('arial', 12, 'bold'), text="stdLoan", bd=7, anchor='w',
                                bg='gainsboro', justify=LEFT)
        self.lblstdLoan.grid(row=2, column=0, sticky=W)
        self.txtstdLoan = Entry(LeftFrame2Right, font=('arial', 12, 'bold'), bd=5, width=20, justify='left',
                                textvariable=stdLoan)
        self.txtstdLoan.grid(row=2, column=1)

        self.lblNIPayment = Label(LeftFrame2Right, font=('arial', 12, 'bold'), text="NIPayment", bd=7, anchor='w',
                                  bg='gainsboro', justify=LEFT)
        ...
        # ==========================================================================================
        self.lblPayday = Label(RightFrame2a, font=('arial', 12, 'bold'), text="Payday", bd=7, anchor='w',
                               bg='gainsboro', justify=LEFT)
        ...
        self.lblTaxPeriod = Label(RightFrame2b, font=('arial', 12, 'bold'), text="TaxPeriod", bd=7, anchor='w',
                                  bg='gainsboro', justify=LEFT)
        self.lblTaxPeriod.grid(row=0, column=0, sticky=W)
        self.txtTaxPeriod = Entry(RightFrame2b, font=('arial', 12, 'bold'), bd=5, width=17, justify='left',
                                  textvariable=TaxPeriod)
        self.txtTaxPeriod.grid(row=0, column=1)

        self.lblTaxcode = Label(RightFrame2b, font=('arial', 12, 'bold'), text="TaxCode", bd=7, anchor='w',
                                bg='gainsboro', justify=LEFT)
        self.lblTaxcode.grid(row=1, column=0, sticky=W)
        self.txtTaxcode = Entry(RightFrame2b, font=('arial', 12, 'bold'), bd=5, width=17, justify='left',
                                textvariable=Taxcode)
        self.txtTaxcode.grid(row=1, column=1)

        self.lblNINumber = Label(RightFrame2b, font=('arial', 12, 'bold'), text="NI Number", bd=7, anchor='w',
                                 bg='gainsboro', justify=LEFT)
        self.lblNINumber.grid(row=2, column=0, sticky=W)
        self.txtNINumber = Entry(RightFrame2b, font=('arial', 12, 'bold'), bd=5, width=17, justify='left',
                                 textvariable=NINumber)
        self.txtNINumber.grid(row=2, column=1)

        self.lblNIcode = Label(RightFrame2b, font=('arial', 12, 'bold'), text="NIcode", bd=7, anchor='w',
                               bg='gainsboro', justify=LEFT)
        self.lblNIcode.grid(row=3, column=0, sticky=W)
        self.txtNIcode = Entry(RightFrame2b, font=('arial', 12, 'bold'), bd=5, width=17, justify='left',
                               textvariable=NIcode)
        self.txtNIcode.grid(row=3, column=1)

        self.lblTaxablepay = Label(RightFrame2c, font=('arial', 12, 'bold'), text="Taxablepay", bd=7, anchor='w',
                                   bg='gainsboro', justify=LEFT)
        ...
        self.lblPensionablepay = Label(RightFrame2c, font=('arial', 12, 'bold'), text="pensionablepay", bd=7,
                                       anchor='w', bg='gainsboro', justify=LEFT)
        ...
        self.lblNetPay = Label(RightFrame2d, font=('arial', 12, 'bold'), text="NetPay", bd=7, anchor='w',
                               bg='gainsboro', justify=LEFT)
        self.lblNetPay.grid(row=0, column=0, sticky=W)
        self.txtNetPay = Entry(RightFrame2d, font=('arial', 12, 'bold'), bd=5, width=17, justify='left',
                               textvariable=NetPay)
        self.txtNetPay.grid(row=0, column=1)

        self.lblGrossPay = Label(RightFrame2d, font=('arial', 12, 'bold'), text="GrossPay", bd=7, anchor='w',
                                 bg='gainsboro', justify=LEFT)
        self.lblGrossPay.grid(row=1, column=0, sticky=W)
        self.txtGrossPay = Entry(RightFrame2d, font=('arial', 12, 'bold'), bd=5, width=17, justify='left',
                                 textvariable=GrossPay)
        self.txtGrossPay.grid(row=1, column=1)

        self.lblDeductions = Label(RightFrame2d, font=('arial', 12, 'bold'), text="Deductions", bd=7, anchor='w',
                                   bg='gainsboro', justify=LEFT)
        self.lblDeductions.grid(row=2, column=0, sticky=W)
        self.txtDeductions = Entry(RightFrame2d, font=('arial', 12, 'bold'), bd=5, width=17, justify='left',
                                   textvariable=Deductions)
        self.txtDeductions.grid(row=2, column=1)
        # =========================================================================================
        self.btnAddNewTotal = Button(TopFrame1, pady=1, bd=4, fg="black", font=('arial', 16, 'bold'), padx=24, width=8,
                                     text="AddNew/Total", command=MonthlySalary).grid(row=0, column=0, padx=1)
        self.btnPrint = Button(TopFrame1, pady=1, bd=4, fg="black", font=('arial', 16, 'bold'), padx=24, width=8,
                               text="Print", command=iprint).grid(row=0, column=1, padx=1)
        self.btnDisplay = Button(TopFrame1, pady=1, bd=4, fg="black", font=('arial', 16, 'bold'), padx=24, width=8,
                                 text="Display", command=DisplayData).grid(row=0, column=2, padx=1)
        self.btnDelete = Button(TopFrame1, pady=1, bd=4, fg="black", font=('arial', 16, 'bold'), padx=24, width=8,
                                text="delete", command=DeleteData).grid(row=0, column=3, padx=1)
        self.btnSearch = Button(TopFrame1, pady=1, bd=4, fg="black", font=('arial', 16, 'bold'), padx=24, width=8,
                                text="Search", command=searchData).grid(row=0, column=4, padx=1)
        self.btnUpdate = Button(TopFrame1, pady=1, bd=4, fg="black", font=('arial', 16, 'bold'), padx=24, width=8,
                                text="Update", command=update).grid(row=0, column=5, padx=1)
        self.btnReset = Button(TopFrame1, pady=1, bd=4, fg="black", font=('arial', 16, 'bold'), padx=24, width=8,
                               text="Reset", command=reset).grid(row=0, column=6, padx=1)
        self.btnExit = Button(TopFrame1, pady=1, bd=4, fg="black", font=('arial', 16, 'bold'), padx=24, width=8,
                              text="Exit", command=iQuit).grid(row=0, column=7, padx=1)
        # ==========================================================================================
